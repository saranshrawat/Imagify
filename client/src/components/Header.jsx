...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-10 py-2 flex items-center gap-2 rounded-full'
             whileHover={{scale:1.05}}  
             whileTap={{scale:.7}}
             initial={{opacity:0}}
             animate={{opacity:1}}
            transition={{ default:{duration:0.2}, opacity:{delay:0.3}, duration:.3}}
